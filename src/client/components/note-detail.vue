<template>
<div class="dp-note-detail" tabindex="-1" :class="{ shadow: $store.state.device.useShadow, round: $store.state.device.roundedCorners }">
	<button
		class="more"
	...
	<dp-renote class="renote" v-if="isRenote" :note="note" mini/>
	<article>
		<header>
			<dp-avatar class="avatar" :user="appearNote.user"/>
			<div>
				<router-link class="name" :to="appearNote.user | userPage"><dp-user-name :user="appearNote.user"/></router-link>
				<span class="username"><dp-acct :user="appearNote.user"/></span>
			</div>
		</header>
		<div class="body">
			...
			<div class="content" v-show="appearNote.cw == null || showContent">
				...
				<div class="files" v-if="appearNote.files.length > 0">
					<dp-media-list :media-list="appearNote.files" :raw="true"/>
				</div>
				<dp-poll v-if="appearNote.poll" :note="appearNote"/>
				<dp-url-preview v-for="url in urls" :url="url" :key="url" :detail="true"/>
				...
				<div class="renote" v-if="appearNote.renote">
					<dp-note-preview :note="appearNote.renote"/>
				</div>
			</div>
		</div>
		<router-link class="time" :to="appearNote | notePage">
			<dp-time :time="appearNote.createdAt" mode="detail"/>
		</router-link>
		...
		<footer>
			<dp-reactions-viewer :note="appearNote"/>
